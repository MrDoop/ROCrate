...
### Collect information into lists
## Get all dataobject IDs for later
...
### Instantiate a list of timeseries references with the corresponding dataobject ID
...
### Create the relationship tree, not currently used
prev_objects = []
